...
- `/algorithms/dfs` — recorrido en profundidad de zonas similares.
- `/algorithms/bfs` — recorrido por niveles.
...
- **DFS / BFS** (`/algorithms/dfs`, `/algorithms/bfs`): recorren el grafo de distritos construido con similitud de suelo + proximidad geográfica (`backend/graph.py`). Útiles para explorar vecindarios de calidad de suelo o capas en el mapa.
